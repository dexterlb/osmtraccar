...
class PointShower(private val context: Context) {
    ...
    fun initOsmAndApi(eventListener: OsmAndHelper.OsmandEventListener, osmandPackage: String, activity: Activity): Boolean {
        ...
        return aidlHelper.bindService(osmandPackage)
    }
